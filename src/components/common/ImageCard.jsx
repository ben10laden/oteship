...
const ImageCard = ({ title, description, image }) => {
  return (
    <div className="flex-1" data-aos="fade-down" data-aos-delay="400">
      <div className="transition-colors duration-200 flex flex-col p-5 bg-[var(--color-bg-primary)] dark:bg-[var(--color-bg-dark)] rounded-md gap-5 drop-shadow-sm flex-1">
        <Link
          to="/ceramics"
